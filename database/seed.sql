...
-- Suite Room (5 rooms)
(4, 'STE-001', 'available'), (4, 'STE-002', 'available'), (4, 'STE-003', 'available'), (4, 'STE-004', 'available'), (4, 'STE-005', 'available'),
-- Share Room (5 rooms)
(5, 'SHR-001', 'available'), (5, 'SHR-002', 'available'), (5, 'SHR-003', 'available'), (5, 'SHR-004', 'available'), (5, 'SHR-005', 'available'),
-- Large Room (5 rooms)
(6, 'LRG-001', 'available'), (6, 'LRG-002', 'available'), (6, 'LRG-003', 'available'), (6, 'LRG-004', 'available'), (6, 'LRG-005', 'available'),
